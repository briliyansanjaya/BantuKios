<?php $__env->startSection('container'); ?>
    <div class="container d-flex justify-content-center min-vh-100 pt-4">
                            ...
                            <div class="col-lg-8">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <h5 class="card-title fw-bold"><?php echo e(Str::limit($product->products[0]->name, 15)); ?></h5>
                                        <div class="d-flex">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Barbatos-Shop\resources\views/customer/cart.blade.php ENDPATH**/ ?>